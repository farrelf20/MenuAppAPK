package com.example.menuapp.ui.menu
...
import com.example.menuapp.Adapter.MyBestDealsAdapter
import com.example.menuapp.Adapter.MyCategoriesAdapter
import com.example.menuapp.Common.SpacesItemDecoration
            ...
            override fun getSpanSize(position: Int): Int {
                return if(adapter != null)
                {
                    when(adapter!!.getItemViewType(position)){
                        com.example.menuapp.Common.Common.DEFAULT_COLUMN_COUNT -> 1
                        com.example.menuapp.Common.Common.FULL_WIDTH_COLUMN -> 2
                        else -> -1
                    }
                }else
                    -1
